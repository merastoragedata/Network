...
const SCHEMAS = {
  ...
  Lines: ['id', 'name', 'from', 'to', 'voltage', 'circuit', 'flowDir', 'status', 'color', 'verify', 'notes'],
...
function setupSheets() {
  ...
  const substations = [
    ...
    ['PADGHAPG',   '765/400 kV Padgha PG',              765, 'PG',        'Konkan',     222, 512, 270, 19.42, 73.13, '', 'yes', '',        'no',  'Western terminal of the Chandrapur–Padghe HVDC bipole'],
    ['BOISRPG',    '400 kV Boisar PG',                  400, 'PG',        'Konkan',      166, 186, 202, 19.8, 72.76, '', 'no',  '',        'no',  ''],
    ['TARAPUR',    '400 kV Tarapur',                    400, 'MSETCL',    'Konkan',     185, 310, 189, 19.83, 72.66, '', 'no',  'nuclear', 'no',  'TAPS nuclear generation'],
    ['PADGE2',     '400 kV Padghe-2',                   400, 'MSETCL',    'Konkan',     204, 418, 216, 19.41, 73.12, '', 'no',  '',        'no',  ''],
    ['KUDUS',      '400 kV Kudus',                      400, 'MSETCL',    'Konkan',     204, 620, 216, 19.55, 73.15, '', 'no',  '',        'no',  ''],
    ['KARGAR',     '400 kV Kargar',                     400, 'MSETCL',    'Konkan',     204, 713, 202, 19.03, 73.06, '', 'no',  '',        'no',  ''],
    ['VIKHROLI',   '400 kV Vikhroli',                   400, 'MSETCL',    'Konkan',     204, 806, 162, 19.11, 72.93, '', 'no',  '',        'yes', 'label partly unreadable'],
    ['KALWA2',     '400 kV Kalwa-2',                    400, 'MSETCL',    'Konkan',      166, 930, 216, 19.2, 73.0, '', 'no',  '',        'no',  'Kalwa frequency reference bus'],
    ['NAGOTHANE',  '400 kV Nagothane',                  400, 'MSETCL',    'Konkan',      148, 1023, 189, 18.53, 73.13, '', 'no',  '',        'no',  ''],
    ['DABHOL',     '400 kV Dabhol',                     400, 'IPP',       'Konkan',      166, 1147, 189, 17.58, 73.18, '', 'no',  'gas',     'no',  'RGPPL Dabhol CCGT'],
    ['NVMUMPG',    '400 kV Navi Mumbai PG',             400, 'PG',        'Konkan',     481, 806, 176, 19.03, 73.02, '', 'no',  '',        'no',  ''],

    ['DHULE',      '400 kV Dhule',                      400, 'MSETCL',    'N. Maha',    555, 155, 202, 20.9, 74.77, '', 'no',  '',        'no',  ''],
    ['DHULEBD',    '400 kV Dhule BD',                   400, 'MSETCL',    'N. Maha',    555, 93, 176, 20.91, 74.8, '', 'no',  '',        'no',  ''],
    ['IBNASIK',    '400 kV Indiabulls Nashik',                   400, 'MSETCL',    'N. Maha',    610, 232, 176, 19.85, 74.0, '', 'no',  'thermal', 'yes', 'Indiabulls (RattanIndia) Nashik, Sinnar'],
    ['KHNDWA',     '400 kV Khandwa',                    400, 'INTERSTATE','N. Maha',    832, 93, 176, 21.82, 76.35, '', 'no',  '',        'no',  'MP interface'],
    ['SDSRV',      '400 kV Sardar Sarovar',             400, 'INTERSTATE','N. Maha',    388, 93, 176, 21.83, 73.75, '', 'no',  'hydro',   'no',  'Sardar Sarovar hydro, Gujarat'],
    ['VDODRAPG',   '400 kV Vadodara PG',                400, 'PG',        'N. Maha',    222, 93, 176, 22.31, 73.18, '', 'no',  '',        'no',  'Gujarat interface'],
    ['EKTUNI',     '400 kV Ektuni',                     400, 'MSETCL',    'N. Maha',    814, 170, 176, 19.75, 75.5, '', 'no',  '',        'no',  ''],
    ['BABHLESHWAR','400 kV Babhaleshwar',               400, 'MSETCL',    'N. Maha',    703, 310, 297, 19.55, 74.6, '', 'no',  '',        'yes', 'large multi-bay bus — confirm connections'],

    ['TALEGAONPG', '765/400 kV Talegaon PG',            765, 'PG',        'W. Maha',    555, 666, 243, 18.73, 73.68, '', 'no',  '',        'no',  ''],
    ['CHAKAN',     '400 kV Chakan',                     400, 'MSETCL',    'W. Maha',    796, 728, 202, 18.76, 73.86, '', 'no',  '',        'no',  ''],
    ['PUNEGIS',    '400 kV Pune GIS',                   400, 'MSETCL',    'W. Maha',    703, 775, 202, 18.52, 73.86, '', 'no',  '',        'no',  ''],
    ['LONIKAND',   '400 kV Lonikand',                   400, 'MSETCL',    'W. Maha',    555, 868, 202, 18.6, 73.98, '', 'no',  '',        'no',  ''],
    ['LNKND2',     '400 kV Lonikand-2',                 400, 'MSETCL',    'W. Maha',    962, 837, 202, 18.61, 73.99, '', 'no',  '',        'no',  ''],
    ['JEJURY',     '400 kV Jejuri',                     400, 'MSETCL',    'W. Maha',    814, 946, 176, 18.28, 74.16, '', 'no',  '',        'no',  ''],
    ['KOYNA4',     '400 kV Koyna-4',                    400, 'MSETCL',    'W. Maha',    462, 961, 189, 17.4, 73.75, '', 'no',  'hydro',   'no',  'Koyna HEP Stage IV'],
    ['KOYNAAN',    '400 kV Koyna AN',                   400, 'MSETCL',    'W. Maha',    462, 1023, 189, 17.39, 73.76, '', 'no',  'hydro',   'no',  'separate from Koyna-4'],
    ['KARAD2',     '400 kV Karad-2',                    400, 'MSETCL',    'W. Maha',    925, 1023, 202, 17.29, 74.18, '', 'no',  '',        'no',  ''],
    ['KARJAT',     '400 kV Karjat',                     400, 'MSETCL',    'W. Maha',    1110, 946, 176, 18.92, 75.01, '', 'no',  '',        'no',  ''],
    ['KLPHR3',     '400 kV Kolhapur-3',                 400, 'MSETCL',    'W. Maha',    610, 1085, 189, 16.7, 74.24, '', 'no',  '',        'no',  ''],
    ['JSW',        '400 kV JSW',                        400, 'IPP',       'W. Maha',    555, 1147, 162, 17.28, 73.23, '', 'no',  'thermal', 'no',  'JSW Energy'],
    ['ALKUD',      '400 kV Alkud',                      400, 'MSETCL',    'W. Maha',    777, 1147, 176, 17.15, 74.6, '', 'no',  '',        'no',  ''],
    ['KUPWADPG',   '400 kV Kupwad PG',                  400, 'PG',        'W. Maha',    666, 1209, 176, 16.87, 74.62, '', 'no',  '',        'no',  ''],
    ['MAPUSA',     '400 kV Mapusa',                     400, 'INTERSTATE','W. Maha',    703, 1256, 162, 15.59, 73.81, '', 'no',  '',        'no',  'Goa interface'],
    ['NANDRA',     '400 kV Nandra',                     400, 'MSETCL',    'W. Maha',    814, 1256, 162, 16.95, 74.5, '', 'no',  '',        'yes', ''],
    ['RAICHR',     '400 kV Raichur',                    400, 'INTERSTATE','W. Maha',    980, 1178, 189, 16.2, 77.36, '', 'no',  'thermal', 'no',  'Karnataka interface'],
    ['SOLPRPG',    '765/400 kV Solapur PG',             765, 'PG',        'W. Maha',    1054, 1085, 243, 17.66, 75.9, '', 'no',  '',        'no',  ''],
    ['SOLPR3',     '400 kV Solapur-3',                  400, 'MSETCL',    'W. Maha',    1147, 1023, 189, 17.67, 75.91, '', 'no',  'thermal', 'no',  'NTPC Solapur nearby'],
    ['KALAMBPG',   '400 kV Kalamb PG',                  400, 'PG',        'W. Maha',    1147, 1224, 176, 18.1, 76.0, '', 'no',  '',        'yes', ''],

    ['AURNGBDPG',  '765/400 kV Aurangabad PG',          765, 'PG',        'Marathwada', 648, 837, 216, 19.88, 75.34, '', 'no',  '',        'no',  'appears at several places on the SLDC sheet as an off-page connector'],
    ['PARLY2',     '400 kV Parli-2',                    400, 'MSETCL',    'Marathwada', 1369, 1023, 216, 18.85, 76.53, '', 'no',  'thermal', 'no',  'Parli TPS'],
    ['PARLYPG',    '765/400 kV Parli PG',               765, 'PG',        'Marathwada', 1332, 1178, 230, 18.86, 76.54, '', 'no',  '',        'no',  ''],
    ['NEWPARLYPG', '400 kV New Parli PG',               400, 'PG',        'Marathwada', 1406, 1224, 202, 18.87, 76.55, '', 'no',  '',        'no',  ''],
    ['NANDED',     '400 kV Nanded',                     400, 'MSETCL',    'Marathwada', 1554, 930, 202, 19.15, 77.32, '', 'no',  '',        'no',  ''],
    ['DHRWL',      '400 kV Dharwal',                    400, 'MSETCL',    'Marathwada', 1258, 914, 176, 19.2, 76.8, '', 'no',  '',        'yes', 'spelling unconfirmed'],

    ['BHSWL2',     '400 kV Bhusawal-2',                 400, 'MSETCL',    'Vidarbha',   1110, 93, 230, 21.04, 75.79, '', 'no',  'thermal', 'no',  'Bhusawal TPS'],
    ['BHSWL3',     '400 kV Bhusawal-3',                 400, 'MSETCL',    'Vidarbha',   1036, 170, 202, 21.05, 75.8, '', 'no',  'thermal', 'no',  ''],
    ['AKOLAAD',    '400 kV Akola-AD',                   400, 'MSETCL',    'Vidarbha',   1295, 170, 202, 20.7, 77.0, '', 'no',  '',        'no',  ''],
    ['AKOLA',      '400 kV Akola',                      400, 'MSETCL',    'Vidarbha',   1462, 248, 202, 20.71, 77.01, '', 'no',  '',        'no',  ''],
    ['RTNIND',     '400 kV RattanIndia Amravati',       400, 'IPP',       'Vidarbha',   1295, 248, 202, 20.93, 77.76, '', 'no',  'thermal', 'yes', 'AMT read as Amravati — please confirm'],
    ['ARGBD3',     '400 kV Aurangabad-3',               400, 'MSETCL',    'Vidarbha',   1147, 279, 189, 19.89, 75.35, '', 'no',  '',        'no',  ''],
    ['BAITUL',     '400 kV Baitul',                     400, 'INTERSTATE','Vidarbha',   1536, 170, 176, 21.9, 77.9, '', 'no',  '',        'no',  'MP interface'],
    ['KORADY',     '400 kV Koradi Y',                   400, 'MSETCL',    'Vidarbha',   1720, 140, 189, 21.24, 79.09, '', 'no',  'thermal', 'yes', 'relation to Koradi-2/-3 to confirm'],
    ['KHPKD2',     '400 kV Khaparkheda-2',              400, 'MSETCL',    'Vidarbha',   1739, 232, 202, 21.28, 79.06, '', 'no',  'thermal', 'no',  'Khaparkheda TPS'],
    ['SATPURA',    '400 kV Satpura',                    400, 'INTERSTATE','Vidarbha',   1832, 108, 162, 22.1, 78.17, '', 'no',  'thermal', 'no',  'MP interface'],
    ['BHILY',      '400 kV Bhilai',                     400, 'INTERSTATE','Vidarbha',  1906, 108, 162, 21.19, 81.38, '', 'no',  '',        'yes', 'read as BHILY — unconfirmed'],
    ['MOUDA',      '400 kV Mouda',                      400, 'IPP',       'Vidarbha',   1758, 310, 176, 21.29, 79.35, '', 'no',  'thermal', 'no',  'NTPC Mouda'],
    ['KORADI3AD',  '400 kV Koradi-3 AD',                400, 'MSETCL',    'Vidarbha',   1406, 512, 230, 21.245, 79.095, '', 'no',  'thermal', 'no',  'Koradi TPS'],
    ['KORADI2',    '400 kV Koradi-2',                   400, 'MSETCL',    'Vidarbha',   1572, 589, 216, 21.25, 79.1, '', 'no',  'thermal', 'no',  ''],
    ['APML',       '400 kV APML Tiroda',                400, 'IPP',       'Vidarbha',   1295, 589, 189, 21.41, 79.94, '', 'no',  'thermal', 'yes', 'Adani Power Maharashtra Ltd, Tiroda'],
    ['WRDHAPG',    '765/400 kV Wardha PG',              765, 'PG',        'Vidarbha',   1646, 496, 256, 20.75, 78.6, '', 'no',  '',        'no',  ''],
    ['WARORAPG',   '400 kV Warora PG',                  400, 'PG',        'Vidarbha',   1610, 666, 202, 20.24, 79.01, '', 'no',  '',        'no',  ''],
    ['WARORA',     '400 kV Warora',                     400, 'MSETCL',    'Vidarbha',   1591, 728, 189, 20.23, 79.0, '', 'no',  '',        'no',  ''],
    ['NZBOL',      '400 kV Nizamabad',                  400, 'INTERSTATE','Vidarbha',   1758, 666, 176, 18.67, 78.09, '', 'no',  '',        'yes', 'read as NZBOL — unconfirmed'],
    ['DURG',       '400 kV Durg',                       400, 'INTERSTATE','Vidarbha',   1832, 666, 162, 21.19, 81.28, '', 'no',  '',        'no',  'Chhattisgarh interface'],
    ['SEONI',      '400 kV Seoni',                      400, 'INTERSTATE','Vidarbha',   1665, 744, 162, 22.09, 79.55, '', 'no',  '',        'no',  'MP interface'],
    ['RAIPUR',     '400 kV Raipur',                     400, 'INTERSTATE','Vidarbha',  1961, 620, 176, 21.25, 81.63, '', 'no',  '',        'no',  'Chhattisgarh interface'],
    ['CHDPR',      '400 kV Chandrapur',                 400, 'MSETCL',    'Vidarbha',  1850, 775, 216, 19.97, 79.3, '', 'yes', 'thermal', 'no',  'Chandrapur TPS + eastern terminal of the Chandrapur–Padghe HVDC bipole'],
    ['CHDPR2',     '400 kV Chandrapur-2',               400, 'MSETCL',    'Vidarbha',  1850, 852, 216, 19.975, 79.305, '', 'no',  'thermal', 'no',  ''],
    ['CHDPRSW',    '400 kV Chandrapur SW',              400, 'MSETCL',    'Vidarbha',   1739, 914, 216, 19.98, 79.31, '', 'no',  '',        'no',  'switchyard'],
    ['BDRVT',      '400 kV Bhadravati',                 400, 'MSETCL',    'Vidarbha',  1998, 713, 189, 20.1, 79.12, '', 'no',  '',        'no',  ''],

    // ---- OFF-PAGE CONNECTORS (same physical station, drawn again) ----
    ['AURNGBDPG_B','765/400 kV Aurangabad PG',          765, 'PG',        'Vidarbha',  1942, 512, 189, 19.88, 75.34, 'AURNGBDPG', 'no', '', 'no', 'off-page connector for Aurangabad PG'],
    ['AURNGBDPG_C','765/400 kV Aurangabad PG',          765, 'PG',        'N. Maha',    370, 232, 176, 19.88, 75.34, 'AURNGBDPG', 'no', '', 'no', 'off-page connector for Aurangabad PG'],
    ['PADGHAPG_B', '765/400 kV Padgha PG',              765, 'PG',        'W. Maha',    462, 760, 176, 19.42, 73.13, 'PADGHAPG',  'no', '', 'no', 'off-page connector for Padgha PG']
