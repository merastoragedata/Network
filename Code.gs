...
function setupSheets() {
  ...
  const substations = [
    ...
    ['PADGHAPG',   '765/400 kV Padgha PG',              765, 'PG',        'Konkan',     620, 980, 300, 19.42, 73.13, '', 'yes', '',        'no',  'Western terminal of the Chandrapur–Padghe HVDC bipole'],
    ['BOISRPG',    '400 kV Boisar PG',                  400, 'PG',        'Konkan',      180, 540, 230, 19.8, 72.76, '', 'no',  '',        'no',  ''],
    ['TARAPUR',    '400 kV Tarapur',                    400, 'MSETCL',    'Konkan',     180, 760, 230, 19.83, 72.66, '', 'no',  'nuclear', 'no',  'TAPS nuclear generation'],
    ['PADGE2',     '400 kV Padghe-2',                   400, 'MSETCL',    'Konkan',     620, 760, 230, 19.41, 73.12, '', 'no',  '',        'no',  ''],
    ['KUDUS',      '400 kV Kudus',                      400, 'MSETCL',    'Konkan',     180, 980, 230, 19.55, 73.15, '', 'no',  '',        'no',  ''],
    ['KARGAR',     '400 kV Kargar',                     400, 'MSETCL',    'Konkan',     180, 1200, 230, 19.03, 73.06, '', 'no',  '',        'no',  ''],
    ['VIKHROLI',   '400 kV Vikhroli',                   400, 'MSETCL',    'Konkan',     180, 1420, 230, 19.11, 72.93, '', 'no',  '',        'yes', 'label partly unreadable'],
    ['KALWA2',     '400 kV Kalwa-2',                    400, 'MSETCL',    'Konkan',      180, 1640, 230, 19.2, 73.0, '', 'no',  '',        'no',  'Kalwa frequency reference bus'],
    ['NAGOTHANE',  '400 kV Nagothane',                  400, 'MSETCL',    'Konkan',      180, 2080, 230, 18.53, 73.13, '', 'no',  '',        'no',  ''],
    ['DABHOL',     '400 kV Dabhol',                     400, 'IPP',       'Konkan',      180, 2520, 230, 17.58, 73.18, '', 'no',  'gas',     'no',  'RGPPL Dabhol CCGT'],
    ['NVMUMPG',    '400 kV Navi Mumbai PG',             400, 'PG',        'Konkan',     620, 1420, 230, 19.03, 73.02, '', 'no',  '',        'no',  ''],

    ['DHULE',      '400 kV Dhule',                      400, 'MSETCL',    'N. Maha',    700, 540, 230, 20.9, 74.77, '', 'no',  '',        'no',  ''],
    ['DHULEBD',    '400 kV Dhule BD',                   400, 'MSETCL',    'N. Maha',    700, 330, 230, 20.91, 74.8, '', 'no',  '',        'no',  ''],
    ['IBNASIK',    '400 kV Indiabulls Nashik',                   400, 'MSETCL',    'N. Maha',    1150, 540, 230, 19.85, 74.0, '', 'no',  'thermal', 'yes', 'Indiabulls (RattanIndia) Nashik, Sinnar'],
    ['KHNDWA',     '400 kV Khandwa',                    400, 'INTERSTATE','N. Maha',    1150, 330, 230, 21.82, 76.35, '', 'no',  '',        'no',  'MP interface'],
    ['SDSRV',      '400 kV Sardar Sarovar',             400, 'INTERSTATE','N. Maha',    700, 120, 230, 21.83, 73.75, '', 'no',  'hydro',   'no',  'Sardar Sarovar hydro, Gujarat'],
    ['VDODRAPG',   '400 kV Vadodara PG',                400, 'PG',        'N. Maha',    300, 120, 230, 22.31, 73.18, '', 'no',  '',        'no',  'Gujarat interface'],
    ['EKTUNI',     '400 kV Ektuni',                     400, 'MSETCL',    'N. Maha',    1600, 330, 230, 19.75, 75.5, '', 'no',  '',        'no',  ''],
    ['BABHLESHWAR','400 kV Babhaleshwar',               400, 'MSETCL',    'N. Maha',    1150, 760, 340, 19.55, 74.6, '', 'no',  '',        'yes', 'large multi-bay bus — confirm connections'],

    ['TALEGAONPG', '765/400 kV Talegaon PG',            765, 'PG',        'W. Maha',    1150, 980, 290, 18.73, 73.68, '', 'no',  '',        'no',  ''],
    ['CHAKAN',     '400 kV Chakan',                     400, 'MSETCL',    'W. Maha',    1600, 1200, 230, 18.76, 73.86, '', 'no',  '',        'no',  ''],
    ['PUNEGIS',    '400 kV Pune GIS',                   400, 'MSETCL',    'W. Maha',    1150, 1200, 230, 18.52, 73.86, '', 'no',  '',        'no',  ''],
    ['LONIKAND',   '400 kV Lonikand',                   400, 'MSETCL',    'W. Maha',    1150, 1420, 230, 18.6, 73.98, '', 'no',  '',        'no',  ''],
    ['LNKND2',     '400 kV Lonikand-2',                 400, 'MSETCL',    'W. Maha',    1700, 1420, 230, 18.61, 73.99, '', 'no',  '',        'no',  ''],
    ['JEJURY',     '400 kV Jejuri',                     400, 'MSETCL',    'W. Maha',    1300, 1640, 230, 18.28, 74.16, '', 'no',  '',        'no',  ''],
    ['KOYNA4',     '400 kV Koyna-4',                    400, 'MSETCL',    'W. Maha',    400, 1860, 230, 17.4, 73.75, '', 'no',  'hydro',   'no',  'Koyna HEP Stage IV'],
    ['KOYNAAN',    '400 kV Koyna AN',                   400, 'MSETCL',    'W. Maha',    400, 2080, 230, 17.39, 73.76, '', 'no',  'hydro',   'no',  'separate from Koyna-4'],
    ['KARAD2',     '400 kV Karad-2',                    400, 'MSETCL',    'W. Maha',    1800, 2080, 230, 17.29, 74.18, '', 'no',  '',        'no',  ''],
    ['KARJAT',     '400 kV Karjat',                     400, 'MSETCL',    'W. Maha',    2500, 1860, 230, 18.92, 75.01, '', 'no',  '',        'no',  ''],
    ['KLPHR3',     '400 kV Kolhapur-3',                 400, 'MSETCL',    'W. Maha',    620, 2300, 230, 16.7, 74.24, '', 'no',  '',        'no',  ''],
    ['JSW',        '400 kV JSW',                        400, 'IPP',       'W. Maha',    300, 2300, 230, 17.28, 73.23, '', 'no',  'thermal', 'no',  'JSW Energy'],
    ['ALKUD',      '400 kV Alkud',                      400, 'MSETCL',    'W. Maha',    1000, 2520, 230, 17.15, 74.6, '', 'no',  '',        'no',  ''],
    ['KUPWADPG',   '400 kV Kupwad PG',                  400, 'PG',        'W. Maha',    1400, 2740, 230, 16.87, 74.62, '', 'no',  '',        'no',  ''],
    ['MAPUSA',     '400 kV Mapusa',                     400, 'INTERSTATE','W. Maha',    620, 2740, 230, 15.59, 73.81, '', 'no',  '',        'no',  'Goa interface'],
    ['NANDRA',     '400 kV Nandra',                     400, 'MSETCL',    'W. Maha',    1000, 2740, 230, 16.95, 74.5, '', 'no',  '',        'yes', ''],
    ['RAICHR',     '400 kV Raichur',                    400, 'INTERSTATE','W. Maha',    2200, 2520, 230, 16.2, 77.36, '', 'no',  'thermal', 'no',  'Karnataka interface'],
    ['SOLPRPG',    '765/400 kV Solapur PG',             765, 'PG',        'W. Maha',    2600, 2300, 290, 17.66, 75.9, '', 'no',  '',        'no',  ''],
    ['SOLPR3',     '400 kV Solapur-3',                  400, 'MSETCL',    'W. Maha',    2900, 2080, 230, 17.67, 75.91, '', 'no',  'thermal', 'no',  'NTPC Solapur nearby'],
    ['KALAMBPG',   '400 kV Kalamb PG',                  400, 'PG',        'W. Maha',    2600, 2740, 230, 18.1, 76.0, '', 'no',  '',        'yes', ''],

    ['AURNGBDPG',  '765/400 kV Aurangabad PG',          765, 'PG',        'Marathwada', 2300, 2080, 290, 19.88, 75.34, '', 'no',  '',        'no',  'appears at several places on the SLDC sheet as an off-page connector'],
    ['PARLY2',     '400 kV Parli-2',                    400, 'MSETCL',    'Marathwada', 3550, 1860, 230, 18.85, 76.53, '', 'no',  'thermal', 'no',  'Parli TPS'],
    ['PARLYPG',    '765/400 kV Parli PG',               765, 'PG',        'Marathwada', 3400, 2520, 290, 18.86, 76.54, '', 'no',  '',        'no',  ''],
    ['NEWPARLYPG', '400 kV New Parli PG',               400, 'PG',        'Marathwada', 3400, 2740, 230, 18.87, 76.55, '', 'no',  '',        'no',  ''],
    ['NANDED',     '400 kV Nanded',                     400, 'MSETCL',    'Marathwada', 4250, 1640, 230, 19.15, 77.32, '', 'no',  '',        'no',  ''],
    ['DHRWL',      '400 kV Dharwal',                    400, 'MSETCL',    'Marathwada', 3100, 1640, 230, 19.2, 76.8, '', 'no',  '',        'yes', 'spelling unconfirmed'],

    ['BHSWL2',     '400 kV Bhusawal-2',                 400, 'MSETCL',    'Vidarbha',   2450, 120, 270, 21.04, 75.79, '', 'no',  'thermal', 'no',  'Bhusawal TPS'],
    ['BHSWL3',     '400 kV Bhusawal-3',                 400, 'MSETCL',    'Vidarbha',   2200, 330, 230, 21.05, 75.8, '', 'no',  'thermal', 'no',  ''],
    ['AKOLAAD',    '400 kV Akola-AD',                   400, 'MSETCL',    'Vidarbha',   2800, 330, 230, 20.7, 77.0, '', 'no',  '',        'no',  ''],
    ['AKOLA',      '400 kV Akola',                      400, 'MSETCL',    'Vidarbha',   3250, 540, 230, 20.71, 77.01, '', 'no',  '',        'no',  ''],
    ['RTNIND',     '400 kV RattanIndia Amravati',       400, 'IPP',       'Vidarbha',   3250, 330, 230, 20.93, 77.76, '', 'no',  'thermal', 'yes', 'AMT read as Amravati — please confirm'],
    ['ARGBD3',     '400 kV Aurangabad-3',               400, 'MSETCL',    'Vidarbha',   2200, 540, 230, 19.89, 75.35, '', 'no',  '',        'no',  ''],
    ['BAITUL',     '400 kV Baitul',                     400, 'INTERSTATE','Vidarbha',   3700, 540, 230, 21.9, 77.9, '', 'no',  '',        'no',  'MP interface'],
    ['KORADY',     '400 kV Koradi Y',                   400, 'MSETCL',    'Vidarbha',   4250, 120, 230, 21.24, 79.09, '', 'no',  'thermal', 'yes', 'relation to Koradi-2/-3 to confirm'],
    ['KHPKD2',     '400 kV Khaparkheda-2',              400, 'MSETCL',    'Vidarbha',   4250, 330, 230, 21.28, 79.06, '', 'no',  'thermal', 'no',  'Khaparkheda TPS'],
    ['SATPURA',    '400 kV Satpura',                    400, 'INTERSTATE','Vidarbha',   4700, 120, 230, 22.1, 78.17, '', 'no',  'thermal', 'no',  'MP interface'],
    ['BHILY',      '400 kV Bhilai',                     400, 'INTERSTATE','Vidarbha',  4700, 300, 230, 21.19, 81.38, '', 'no',  '',        'yes', 'read as BHILY — unconfirmed'],
    ['MOUDA',      '400 kV Mouda',                      400, 'IPP',       'Vidarbha',   4700, 540, 230, 21.29, 79.35, '', 'no',  'thermal', 'no',  'NTPC Mouda'],
    ['KORADI3AD',  '400 kV Koradi-3 AD',                400, 'MSETCL',    'Vidarbha',   3250, 760, 280, 21.245, 79.095, '', 'no',  'thermal', 'no',  'Koradi TPS'],
    ['KORADI2',    '400 kV Koradi-2',                   400, 'MSETCL',    'Vidarbha',   3700, 980, 270, 21.25, 79.1, '', 'no',  'thermal', 'no',  ''],
    ['APML',       '400 kV APML Tiroda',                400, 'IPP',       'Vidarbha',   2700, 980, 230, 21.41, 79.94, '', 'no',  'thermal', 'yes', 'Adani Power Maharashtra Ltd, Tiroda'],
    ['WRDHAPG',    '765/400 kV Wardha PG',              765, 'PG',        'Vidarbha',   4150, 980, 300, 20.75, 78.6, '', 'no',  '',        'no',  ''],
    ['WARORAPG',   '400 kV Warora PG',                  400, 'PG',        'Vidarbha',   4150, 1200, 230, 20.24, 79.01, '', 'no',  '',        'no',  ''],
    ['WARORA',     '400 kV Warora',                     400, 'MSETCL',    'Vidarbha',   4150, 1420, 230, 20.23, 79.0, '', 'no',  '',        'no',  ''],
    ['NZBOL',      '400 kV Nizamabad',                  400, 'INTERSTATE','Vidarbha',   4700, 2080, 230, 18.67, 78.09, '', 'no',  '',        'yes', 'read as NZBOL — unconfirmed'],
    ['DURG',       '400 kV Durg',                       400, 'INTERSTATE','Vidarbha',   4700, 2300, 230, 21.19, 81.28, '', 'no',  '',        'no',  'Chhattisgarh interface'],
    ['SEONI',      '400 kV Seoni',                      400, 'INTERSTATE','Vidarbha',   4250, 2080, 230, 22.09, 79.55, '', 'no',  '',        'no',  'MP interface'],
    ['RAIPUR',     '400 kV Raipur',                     400, 'INTERSTATE','Vidarbha',  4700, 760, 230, 21.25, 81.63, '', 'no',  '',        'no',  'Chhattisgarh interface'],
    ['CHDPR',      '400 kV Chandrapur',                 400, 'MSETCL',    'Vidarbha',  4700, 1200, 280, 19.97, 79.3, '', 'yes', 'thermal', 'no',  'Chandrapur TPS + eastern terminal of the Chandrapur–Padghe HVDC bipole'],
    ['CHDPR2',     '400 kV Chandrapur-2',               400, 'MSETCL',    'Vidarbha',  4700, 1420, 230, 19.975, 79.305, '', 'no',  'thermal', 'no',  ''],
    ['CHDPRSW',    '400 kV Chandrapur SW',              400, 'MSETCL',    'Vidarbha',   3700, 1640, 230, 19.98, 79.31, '', 'no',  '',        'no',  'switchyard'],
    ['BDRVT',      '400 kV Bhadravati',                 400, 'MSETCL',    'Vidarbha',  4700, 980, 230, 20.1, 79.12, '', 'no',  '',        'no',  ''],

    // ---- OFF-PAGE CONNECTORS (same physical station, drawn again) ----
    ['AURNGBDPG_B','765/400 kV Aurangabad PG',          765, 'PG',        'Vidarbha',  4250, 2300, 230, 19.88, 75.34, 'AURNGBDPG', 'no', '', 'no', 'off-page connector for Aurangabad PG'],
    ['AURNGBDPG_C','765/400 kV Aurangabad PG',          765, 'PG',        'N. Maha',    1700, 1860, 230, 19.88, 75.34, 'AURNGBDPG', 'no', '', 'no', 'off-page connector for Aurangabad PG'],
    ['PADGHAPG_B', '765/400 kV Padgha PG',              765, 'PG',        'W. Maha',    620, 1200, 230, 19.42, 73.13, 'PADGHAPG',  'no', '', 'no', 'off-page connector for Padgha PG']
